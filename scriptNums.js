...
// Llama a la función inicialmente para ajustar la altura
...
class Particle {
    constructor(effect) {
        ...
        this.vy = Math.random() * 0.5 + 0.1; // Velocidad hacia abajo
    ...
    draw(context) {
        ...
        context.beginPath();
        context.arc(this.x, this.y, this.radius / 1.6, 0, Math.PI * 2);
        context.fillStyle = "white";
        context.fill();
